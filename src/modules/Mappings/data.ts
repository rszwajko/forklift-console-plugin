...
import { useNetworkMappings, useProviders } from '_/utils/fetch';
import { groupVersionKindForObj, resolveProviderRef, ResourceKind } from '_/utils/resources';
import { NetworkMapResource, ProviderRef, ProviderResource } from '_/utils/types';
...
export const useFlaNetworkMappings = ({
  namespace,
  name = undefined,
